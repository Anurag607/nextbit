...
const Page: NextPage<{ userDetails: string; cookieIntro }> = ({
  userDetails,
  cookieIntro,
}) => {
  ...
  const [parsedCookies, setParsedCookies] = React.useState(
    JSON.parse(cookieIntro)
  );
  const styling = {
  ...
  const [introContent, SetIntroContent] = React.useState({
    title:
      typeof parsedCookies.title !== "undefined" ? parsedCookies.title : "",
    desc: typeof parsedCookies.desc !== "undefined" ? parsedCookies.desc : "",
    introImage:
      typeof parsedCookies.introImage !== "undefined" &&
      parsedCookies.introImage !== null
        ? parsedCookies.introImage
        : "",
    bgImage:
      typeof parsedCookies.bgImage !== "undefined" &&
      parsedCookies.bgImage !== null
        ? parsedCookies.bgImage
        : "",
  });
      ...
      props: {
        userDetails:
          typeof cookies.currentLoggedIn !== "undefined"
            ...
            : "{}",
        cookieIntro:
          typeof cookies.introContent !== "undefined"
            ? cookies.introContent
            : "{}",
      },
    };
  } else {
